...
--SELECT *
--FROM Eight_Week_Challenge_2.dbo.pizza_names; 

--SELECT *
--FROM Eight_Week_Challenge_2.dbo.pizza_recipes; 

--SELECT *
--FROM Eight_Week_Challenge_2.dbo.pizza_toppings; 

--SELECT *
--FROM Eight_Week_Challenge_2.dbo.runner_orders; 
...
--SELECT *
--FROM Eight_Week_Challenge_2.dbo.runners;